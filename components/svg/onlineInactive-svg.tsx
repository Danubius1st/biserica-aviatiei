export const OnlineInactiveSVG = () => {
  return (
    <svg
      className='stroke-indian-khaki-600 dark:stroke-indian-khaki-400'
      width='36px'
      height='36px'
      viewBox='0 0 24 24'
      fill='none'
    ...
    >
      <circle
        className='fill-indian-khaki-600 dark:fill-indian-khaki-400'
        cx='1'
        cy='1'
        r='1'
